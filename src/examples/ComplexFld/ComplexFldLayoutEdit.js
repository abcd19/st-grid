...
import {ComboboxFldLayoutEdit, LinearGroupLayout,  ImgButtonLayout} from '../../stgrid';
...
export function ComplexFldLayoutEdit(props)
{
 ...
 if(showTypeCombobox == true)
 {
  ...
  lin.push( <Combobox items={list} val = {{raw: val['type']}} onChange={onChangeType} key='combo' widthPix={100}/> );
 }
